              ...
              <nav className="space-y-1 max-h-[calc(100vh-200px)] overflow-y-auto pr-2 custom-scrollbar">
                {sections.map((item) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2.5 rounded-lg text-sm transition-all duration-200 ${activeSection === item.id
              ...
              <div>
                ...
                <div className="prose prose-lg max-w-none space-y-4 text-slate-700">
                  ...
                  <div className="bg-slate-50 p-6 rounded-xl border-l-4 border-slate-400 my-4">
                    <p className="font-semibold text-slate-900">Graphura</p>
                    <p className="text-slate-700">10/305, Near Anurag bhawan, Sector 1, Mansarovar, Jaipur,</p>
                    <p className="text-slate-700">Rajasthan 302020, India</p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p>
                            ...
                            or by submitting a request via mail to Graphura Inc. Graphura
                            10/305, Near Anurag bhawan, Sector 1, Mansarovar, Jaipur, Rajasthan 302020, India.
                          </p>
                        </div>
