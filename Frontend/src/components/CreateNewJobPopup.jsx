...
const PREDEFINED_FIELDS_LIBRARY = [
  // Basic Info
  {
    ...
    icon: <User size={16} />,
    category: "basic",
    tip: "Full name of the applicant",
  },
  {
    key: "email",
    label: "Email Address",
    ...
    icon: <Mail size={16} />,
    category: "basic",
    tip: "Primary email for communication",
  },
  {
    key: "mobile_number",
    label: "Mobile Number",
  ...
  // Education
  {
    ...
    category: "education",
    tip: "e.g., Bachelor's Degree, Master's Degree",
  },
  {
    key: "university_name",
    ...
    category: "education",
    tip: "Name of university or college",
  },
  {
    key: "degree_name",
    label: "Degree Name",
  ...
  // Professional
  {
    ...
    tip: "Years of professional experience",
  },
  {
    key: "current_company",
  ...
  // Skills
  {
    ...
    icon: <Code size={16} />,
    category: "skills",
    tip: "Comma separated technical skills",
  },
  {
    key: "soft_skills",
    label: "Soft Skills",
    ...
    category: "skills",
    tip: "Communication, leadership, etc.",
  },
  {
  ...
  },
  {
    ...
    category: "skills",
    tip: "Languages with proficiency level",
  },
  ...
  },
  {
    ...
    icon: <Link size={16} />,
    category: "portfolio",
    tip: "LinkedIn profile URL",
  },
  {
    key: "behance_dribbble",
    label: "Behance/Dribbble",
    fieldType: "url",
    required: false,
    icon: <Image size={16} />,
    category: "portfolio",
    tip: "Design portfolio links",
  },
...
// MAIN COMPONENT
// ===============================
const CreateNewJobPopup = ({ isOpen, onClose, isEdit = false, jobData = null, fetchJobs }) => {
  ...
  const handleApplyTemplate = (templateKey) => {
    ...
    const newFields = template.suggestedFields
      ...
      .map((field, index) => ({
        ...
        validation:
          field.fieldType === "file" ? { maxFileSizeMB: 2, fileTypes: ["pdf", "docx"] } : {},
        order: index,
      }));
  ...
  const handleCreateJob = async () => {
    ...
    try {
      ...
      const response = await axios.post("/api/admin/create-job", newJob, {
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleJobDetailsChange("totalVacancies", parseInt(e.target.value) || 1)
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              min="1"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewCustomField((prev) => ({ ...prev, placeholder: e.target.value }))
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg"
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center">
              <input
                ...
                onChange={(e) =>
                  setNewCustomField((prev) => ({ ...prev, required: e.target.checked }))
                }
                className="mr-2"
              />
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-sm text-gray-500">
              Required: {newJob.customFields.filter((f) => f.required).length} / Optional:{" "}
          ...
          {newJob.customFields.length === 0 ? (
            <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Add fields from library or create custom ones
              </p>
            </div>
          ) : (
                    ...
                    {field.fieldType === "file" && (
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Max size: {field.validation?.maxFileSizeMB || 2}MB • Formats:{" "}
                          {field.validation?.fileTypes?.join(", ") || "PDF, DOCX"}
                        </p>
                      </div>
                    )}
